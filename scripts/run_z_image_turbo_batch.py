...
CONFIG_FILE = "z-image-turbo-config.json"
PASS_THROUGH = ("image", "size", "strength", "output_format", "enable_safety_checker")
...
def main() -> None:
    ...
    playlist_uuid = get_or_create_playlist(client, config, "Z-Image Turbo Batch")
    ...
    def on_processed(dream: dict[str, Any]) -> None:
        ...
        download_image(client, dream, output_dir / f"{base_name}{suffix}.{ext}")
