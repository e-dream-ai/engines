...
CONFIG_FILE = "qwen-image-config.json"
PASS_THROUGH = ("size", "negative_prompt", "enable_safety_checker")
...
def main() -> None:
    ...
    playlist_uuid = get_or_create_playlist(client, config, "Qwen Image Batch")
